...
function getRoom(){
    $.ajax({
        url:"http://192.9.237.187:8080/api/Room/all",
        type:"GET",
        datatype:"JSON",
...
function postRoom(){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://192.9.237.187:8080/api/Room/save",
        type:"POST",
        datatype:"JSON",
...
function putRoom(idBotonActualizar){
    ...
    console.log(cajas);
    $.ajax({
        url:"http://192.9.237.187:8080/api/Room/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteRoom(idBotonBorrar){
    const swalWithBootstrapButtons = Swal.mixin({
      ...
      swalWithBootstrapButtons.fire({
        ...
        $.ajax({
            url:"http://192.9.237.187:8080/api/Room/"+idBotonBorrar,
            type:"DELETE",
            datatype:"JSON",
            contentType:"application/JSON",
...
function getRoom_Category(){
    $.ajax({
        url:"http://192.9.237.187:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
